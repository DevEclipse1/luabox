...
/**
 * @brief Draw a circle on the sprite buffer.
 * 
 * This function draws the outline of a circle on the `sprite` buffer
 ...
 *        4: color (16-bit RGB565 color for the circle outline)
 * 
